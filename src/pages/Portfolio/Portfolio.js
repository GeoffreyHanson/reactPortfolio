...
import ClickyThumb from './thumbnails/ClickyThumb.PNG';
    ...
    <div className="Portfolio">
      ...
      <div>
        ...
        <PortfolioItem
          ...
          demo="https://pika-card-game.herokuapp.com/"  
          code="https://github.com/GeoffreyHanson/clicky-game"        
        >          
          After each click the cards reshuffle. Click all the different pictures to win the game!
        </PortfolioItem>
        <PortfolioItem
        ...
        >          
          ...
          returning scores from the Face++ API algorithms quantifying "emotion" and "beauty".
          ...
          you can track whether you are getting better at presenting an attractive and cheerful face to the world.
          If you are satisfied with your appearance, Baseline's ongoing feedback can warn you that you're revealing more than you think.
        </PortfolioItem>
      </div>
    </div>
  )
